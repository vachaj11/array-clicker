...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dial = QDial(self.groupBox_5)
        ...
        self.dial_2 = QDial(self.groupBox_6)
        ...
        self.dial_2.setMaximum(32)
        self.dial_2.setSingleStep(1)
        self.dial_2.setValue(16)

        self.verticalLayout_4.addWidget(self.dial_2)
        ...
        QWidget.setTabOrder(self.loader, self.last)
        QWidget.setTabOrder(self.last, self.next)
        QWidget.setTabOrder(self.next, self.loca_out)
        QWidget.setTabOrder(self.loca_out, self.umiste_out)
        QWidget.setTabOrder(self.umiste_out, self.rewrite)
        QWidget.setTabOrder(self.rewrite, self.saver)
        QWidget.setTabOrder(self.saver, self.reload)
        QWidget.setTabOrder(self.reload, self.marker)
        QWidget.setTabOrder(self.marker, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.slider2)
        QWidget.setTabOrder(self.slider2, self.invert)
        QWidget.setTabOrder(self.invert, self.counter)
        QWidget.setTabOrder(self.counter, self.clock)
        QWidget.setTabOrder(self.clock, self.horiz)
        QWidget.setTabOrder(self.horiz, self.verti)
        QWidget.setTabOrder(self.verti, self.ingroup)
        QWidget.setTabOrder(self.ingroup, self.info)
